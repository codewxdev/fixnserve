                        ...
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <div>
                                <span
                                    ...
                                    Device Binding</span>
                                <span class="block text-caption text-text-secondary mt-0.5">Tokens are invalidated if device
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <div>
                                <span
                                    ...
                                    Role Binding</span>
                                <span class="block text-caption text-text-secondary mt-0.5">Tokens auto-revoke immediately
                                ...
                                <tr class="hover:bg-bg-tertiary transition-colors">
                                    <td class="px-5 py-4">
                                        ...
                                        <div class="font-mono text-[10px] text-text-secondary mt-1 flex items-center gap-2">
                                            <span class="bg-bg-primary border border-border-strong px-1.5 py-0.5 rounded"
                                    ...
                                    <td class="px-5 py-4">
                                        ...
                                        <div class="text-caption"
                                            :class="token.isExpiring ? 'text-semantic-error font-bold' : 'text-text-tertiary'"
                                            x-text="token.timeUntil"></div>
                                    </td>
                                    <td class="px-5 py-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            <button @click="viewMetadata(token)" class="btn btn-sm btn-secondary text-xs"
                                                title="Metadata"><i data-lucide="eye" class="w-4 h-4"></i></button>
                        ...
                        <tbody class="divide-y divide-border-default bg-bg-secondary">
                            <template x-for="key in apiKeys" :key="key.id">
                                <tr class="hover:bg-bg-tertiary transition-colors">
                                    ...
                                    <td class="px-5 py-4 text-body-sm text-text-primary" x-text="key.expiry || 'Never'">
                                    </td>
                                    <td class="px-5 py-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            <button @click="viewLogs(key.id)" class="btn btn-sm btn-secondary text-xs"
        ...
        <div x-show="modals.generateKey"
            ...
            <div class="card w-full max-w-lg p-0 shadow-2xl" @click.away="modals.generateKey = false">
                ...
                <div class="p-4 border-t border-border-default flex justify-end gap-3 rounded-b-lg bg-bg-tertiary">
                    ...
                    <button @click="createApiKey()" class="btn btn-primary" :disabled="!newKey.name">Generate
                        Secret</button>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('tokenManagement', () => ({
                    ...
                    rotateApiKey(id) {
                        if (confirm(
                                'Rotate API Key? Any integrations using the old key will break instantly.'
                            )) {
