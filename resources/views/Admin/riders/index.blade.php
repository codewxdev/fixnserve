...
<div id="rider-management-page" 
     class="space-y-6 p-4 md:p-8 bg-gray-50 min-h-screen" 
     x-data="{ openRiderId: null, currentTab: 'profile' }" 
     x-cloak>
    ...
    <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-gray-200">
        <div class="mb-4 sm:mb-0">
            ...
            <p class="text-xs sm:text-sm text-gray-500 mt-1">Manage delivery personnel, track location, assignments, and earnings.</p>
        </div>
        <div class="flex flex-wrap gap-2"> 
            <button class="flex items-center px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 shadow-md transition duration-150 ease-in-out">
    ...
    <section class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
        @php
            $cards = [
                ['title' => 'Total Riders', 'value' => '4,100', 'icon' => 'user', 'color' => 'red', 'trend' => '+5% MoM'],
                ['title' => 'Riders Online', 'value' => '1,850', 'icon' => 'signal', 'color' => 'green', 'trend' => '45%'],
                ['title' => 'Pending KYC', 'value' => '55', 'icon' => 'document', 'color' => 'orange', 'trend' => 'Urgent'],
                ['title' => 'Avg Rating', 'value' => '4.7 / 5', 'icon' => 'star', 'color' => 'yellow', 'trend' => 'High'],
                ['title' => 'Orders Assigned', 'value' => '9,800', 'icon' => 'deliver', 'color' => 'blue', 'trend' => 'Today'],
                ['title' => 'Total Penalties', 'value' => '$1,200', 'icon' => 'ban', 'color' => 'pink', 'trend' => 'Weekly'],
                ['title' => 'Pending Withdrawals', 'value' => '$15,400', 'icon' => 'wallet', 'color' => 'teal', 'trend' => 'High'],
                ['title' => 'Top Vehicle Type', 'value' => 'Bike (70%)', 'icon' => 'bike', 'color' => 'indigo', 'trend' => 'Dominant'],
            ];
        @endphp
        
        @foreach ($cards as $card)
            <div class="bg-white p-3 sm:p-4 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.03] transition duration-300 ease-in-out border border-gray-100">
                <div class="flex items-center justify-between">
                    <p class="text-xs font-medium text-gray-500 truncate">{{ $card['title'] }}</p>
                    <span class="text-[10px] font-semibold text-{{ $card['color'] }}-500 hidden sm:block">{{ $card['trend'] }}</span>
                </div>
    ...
    <div class="mt-8 bg-white p-4 sm:p-6 rounded-xl shadow-2xl border border-gray-100">
        ...
        <div class="sticky top-0 z-10 bg-white pt-1 pb-4 -mx-4 sm:-mx-6 px-4 sm:px-6 border-b border-gray-100 shadow-sm rounded-t-xl">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-10 gap-3 items-center">
                ...
                <div class="col-span-2 sm:col-span-1 flex justify-end">
                    <button class="px-3 py-2 text-sm font-medium text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition duration-150 ease-in-out">
                        Reset
                    </button>
                </div>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50  ">
                    <tr>
                        ...
                        <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[280px]">
                            Rider Info / Vehicle
                        </th>
                        ...
                        <th class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider sticky right-0 bg-gray-50 border-l border-gray-200 min-w-[150px]">
                            Actions
                        </th>
                    </tr>
                </thead>
                    ...
                    <tr class="hover:bg-red-50/50 transition duration-150 ease-in-out group">
                        ...
                        <td class="px-3 sm:px-6 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                <img class="h-10 w-10 rounded-full object-cover shadow-sm mr-3 flex-shrink-0" src="https://via.placeholder.com/150/ef4444/ffffff?text=RJ" alt="Rider Photo">
                                <div>
                            ...
                            <div class="grid grid-cols-2 gap-2 w-full">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-1 mt-1">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-green-500 text-white">Online</span>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center text-xs text-gray-600 mt-1">
                                        <svg class="w-3 h-3 text-yellow-500 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.012 8.73c-.783-.57-.381-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                        4.7 (Avg)
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="px-3 sm:px-6 py-3 whitespace-nowrap text-right text-sm font-medium sticky right-0 bg-white border-l border-gray-200 group-hover:bg-red-50/50">
                            <div class="flex justify-end space-x-2">
                                ...
                                {{-- Live Map --}}
                                <button class="p-2 rounded-full text-blue-500 hover:bg-blue-50 transition duration-150 ease-in-out hidden sm:block" title="Live Tracking">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                </button>
                            </div>
                        </td>
                    ...
                    <div class="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                        <div class="p-4 sm:p-6 bg-red-600">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <button type="button" class="rounded-md text-red-200 hover:text-white" @click="openRiderId = null">
                        ...
                        <nav x-data="{ currentTab: 'profile' }" class="flex space-x-4 px-6 pt-4 border-b border-gray-200 sticky top-0 bg-white z-10 overflow-x-auto">
                            @php
                                $tabs = [
                                    'Profile', 
                                    'KYC & Vehicle', 
                        ...
                        <div class="p-6 flex-1 overflow-y-auto">
                            ...
                            <div x-show="currentTab === 'profile'" class="space-y-6">
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    <div><p class="text-gray-500">Full Name</p><p class="font-medium">John Doe</p></div>
                                    <div><p class="text-gray-500">Contact Number</p><p class="font-medium">+1 (555) 123-4567</p></div>
                                    <div><p class="text-gray-500">Email</p><p class="font-medium">john.d@delivery.com</p></div>
                                    <div><p class="text-gray-500">Date Joined</p><p class="font-medium">2024-01-15</p></div>
                                </div>
                            ...
                            <div x-show="currentTab === 'kyc-vehicle'" class="space-y-6">
                                ...
                                <div class="bg-red-50 p-4 rounded-xl space-y-3 border border-red-200">
                                    ...
                                    <ul class="list-disc list-inside text-sm text-gray-600 space-y-1">
                                        ...
                                        <li><span class="font-medium">Driving License:</span> Approved (Expires 2028)</li>
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    <div><p class="text-gray-500">Vehicle Type</p><p class="font-medium">Motorcycle (Bike)</p></div>
                                    <div><p class="text-gray-500">License Plate</p><p class="font-medium">ABC-789</p></div>
                                    <div><p class="text-gray-500">Model</p><p class="font-medium">Honda CG 125</p></div>
                                    <div><p class="text-gray-500">Registration Docs</p><button class="text-red-600 hover:underline">View File</button></div>
                                </div>
                            </div>
                            ...
                            <div x-show="currentTab === 'shift-tracking'" class="space-y-6">
                                ...
                                <div class="bg-gray-200 p-4 rounded-xl h-64 flex items-center justify-center">
                                    <p class="text-gray-500">Live Map View Placeholder: Current Location, Route, and Heatmap</p>
                                    
                                </div>
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    <div><p class="text-gray-500">Current Shift Start</p><p class="font-medium">10:00 AM</p></div>
                                    <div><p class="text-gray-500">Last GPS Update</p><p class="font-medium text-green-600">14:42 PM (5 seconds ago)</p></div>
                                    <div><p class="text-gray-500">Total Shift Hours (W)</p><p class="font-medium">45 Hours</p></div>
                                    <div><p class="text-gray-500">Auto-Assignment</p><p class="font-medium text-red-600">Enabled</p></div>
                                </div>
                            </div>
                            ...
                            <div x-show="currentTab === 'orders-history'" class="space-y-6">
                                ...
                                <div class="flex justify-between items-center p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-yellow-600">4.7 <span class="text-base text-gray-500">/ 5.0</span></p>
                                    </div>
                                </div>
                                <h4 class="font-medium text-gray-800 mt-4">Recent Order Assignments</h4>
                                <ul class="space-y-2 text-sm text-gray-700">
                                    <li class="p-2 border rounded-md">#ORD-9012 | Status: Completed | Time: 18 mins</li>
                                    <li class="p-2 border rounded-md">#ORD-9013 | Status: Completed | Time: 22 mins</li>
                                    <li class="p-2 border rounded-md">#ORD-9014 | Status: **Cancelled** | Reason: Rider Too Far</li>
                                </ul>
                            </div>
                            ...
                            <div x-show="currentTab === 'earnings-payouts'" class="space-y-6">
                                ...
                                <div class="grid grid-cols-2 gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
                                    <div><p class="text-sm text-gray-500">Total YTD Earnings</p><p class="text-xl font-bold text-green-700">$15,400</p></div>
                                    <div><p class="text-sm text-gray-500">Last Withdrawal</p><p class="text-xl font-bold text-green-700">$500</p></div>
                                </div>
                                
                                <h4 class="font-medium text-gray-800 mt-6">Penalties & Deductions</h4>
                                <ul class="list-disc list-inside text-sm text-gray-600 space-y-1">
                                    <li><span class="font-medium text-red-600">Late Delivery Penalty:</span> $10 (10/01/2025)</li>
                                    <li><span class="font-medium text-red-600">Uniform Violation:</span> $30 (09/15/2025)</li>
                                </ul>

                                <h4 class="font-medium text-gray-800 mt-6">Withdrawal Requests</h4>
                                <p class="text-sm text-gray-500">Pending Request: **$540** (Requested on 10/20/2025)</p>
                                <button class="mt-2 px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700">Approve Withdrawal</button>
                            </div>
