...
<div class="min-h-screen bg-gray-50/50 p-6 space-y-8" x-data="{ 
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Rider Management</h1>
            <p class="text-sm text-gray-500">Manage Logistics, Riders, and Payouts</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="relative bg-white p-6 rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative flex justify-between items-start z-10">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Total Riders</p>
                    <h3 class="text-3xl font-extrabold text-gray-900 mt-2 group-hover:text-indigo-600 transition-colors" x-text="riders.length"></h3>
                </div>
            ...
            <div class="mt-4 flex items-center text-xs text-gray-400">
                <span class="text-indigo-600 font-bold bg-indigo-50 px-1.5 py-0.5 rounded mr-2"><i class="fa-solid fa-arrow-up"></i> Fleet</span>
        ...
        <div class="relative bg-white p-6 rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="mt-4 flex items-center text-xs text-gray-400">
                <span class="text-emerald-600 font-bold bg-emerald-50 px-1.5 py-0.5 rounded mr-2"><i class="fa-solid fa-box-open"></i> Delivered</span>
        ...
        <div class="relative bg-white p-6 rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative flex justify-between items-start z-10">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Pending Verifications</p>
            ...
            <div class="mt-4 flex items-center text-xs text-gray-400">
                <span class="text-amber-600 font-bold bg-amber-50 px-1.5 py-0.5 rounded mr-2"><i class="fa-solid fa-user-clock"></i> KYC</span>
        ...
        <div class="relative bg-white p-6 rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative flex justify-between items-start z-10">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Rider Earnings</p>
            ...
            <div class="mt-4 flex items-center text-xs text-gray-400">
                <span class="text-rose-600 font-bold bg-rose-50 px-1.5 py-0.5 rounded mr-2"><i class="fa-solid fa-coins"></i> Payouts</span>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto">
                        ...
                        <tr class="hover:bg-indigo-50/30 transition duration-150 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900" x-text="rider.name"></div>
                            ...
                            {{-- Operational Stats --}}
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 font-semibold" x-text="rider.stats.orders + ' Delivered'"></div>
                                <div class="text-xs text-gray-500 mt-1"><i class="fa-solid fa-chart-simple mr-1"></i> Revenue: <span x-text="rider.stats.revenue"></span></div>
                            </td>

                            {{-- Wallet & Status --}}
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 font-bold" x-text="formatMoney(rider.wallet.balance)"></div>
                                <div class="mt-1">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full"
                                        :class="{
                                            'bg-green-100 text-green-800': rider.status.toLowerCase() === 'active',
                                            'bg-red-100 text-red-800': rider.status.toLowerCase() === 'deactive' || rider.status.toLowerCase() === 'ban',
                                            'bg-yellow-100 text-yellow-800': rider.status.toLowerCase() === 'suspend'
                                        }"
                                        x-text="rider.status">
                                    </span>
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end items-center gap-2">
                                    <button @click="openVendorId = rider.id" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 p-2 rounded hover:bg-indigo-100 transition" title="View Details">
                                        View Details
                                    </button>
            ...
            <div x-show="filteredriders.length === 0" class="p-10 text-center text-gray-500">
                ...
                <h3 class="text-sm font-medium text-gray-900">No riders found</h3>
            </div>
        </div>
        
        {{-- Footer --}}
        <div class="px-6 py-4 border-t border-gray-100 flex justify-center bg-gray-50">
            <span class="text-xs font-medium text-gray-500">Showing <span x-text="filteredriders.length"></span> riders</span>
        </div>
    </div>
                ...
                <div class="bg-indigo-900 px-6 py-6 text-white shrink-0">
                    ...
                    <div class="flex space-x-6 mt-8 text-sm font-medium overflow-x-auto scrollbar-hide">
                        ...
                        <button @click="currentTab = 'orders'" 
                            ...
                            class="pb-3 border-b-2 transition whitespace-nowrap">Delieveries</button>
                    </div>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-6 bg-gray-50 scroll-smooth">
                    ...
                    <div x-show="currentTab === 'overview'" class="space-y-6">
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                            <h3 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fa-solid fa-motorcycle mr-2 text-indigo-500"></i> Rider Profile</h3>
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <p class="font-medium text-gray-900 mt-1" x-text="activeVendor.address.permanent"></p>
                                </div>
                                <div>
                                ...
                                <div class="flex justify-between items-center border-b border-gray-50 pb-3 last:border-0">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">Order #ORD-115</p>
                                        </div>
                                    </div>
                                    <span class="text-sm font-bold text-green-600">+PKR 350</span>
                                </div>
                                <div class="flex justify-between items-center border-b border-gray-50 pb-3 last:border-0">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-900">Fuel Advance</p>
                                            <p class="text-xs text-gray-500">Deduction</p>
                                        </div>
                                    </div>
                                    <span class="text-sm font-bold text-gray-900">-PKR 1,000</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:shadow-sm transition">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800">Driving License</p>
                                ...
                                <div class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:shadow-sm transition">
                                    <div class="flex items-center space-x-3">
                                        <div class="h-10 w-10 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center text-lg"><i class="fa-solid fa-passport"></i></div>
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800">CNIC / ID Card</p>
                    ...
                    <div x-show="currentTab === 'orders'" class="space-y-4">
                         <div class="bg-white p-10 rounded-xl border border-gray-100 text-center">
                            <i class="fa-solid fa-route text-4xl text-gray-200 mb-3"></i>
                            <p class="text-gray-500">Delivery history not available.</p>
                        </div>
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full transform transition-all">
                ...
                <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                    <h3 class="text-xl font-bold text-gray-900"><i class="fa-solid fa-motorcycle mr-2 text-indigo-500"></i> Onboard New Rider</h3>
                    ...
                    <div class="p-6 space-y-4 max-h-[60vh] overflow-y-auto" :class="isSubmitting ? 'opacity-50 pointer-events-none' : ''">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2">
                                ...
                                <input type="text" name="name" required placeholder="John Doe" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2.5 border">
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                                <input type="email" name="email" required placeholder="john@example.com" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2.5 border">
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                                <input type="text" name="phone" placeholder="+92 300..." class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2.5 border">
                            </div>

                            <div class="col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                                <input type="password" name="password" required placeholder="Min 8 characters" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2.5 border">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">City</label>
                                <input type="text" name="city" placeholder="Islamabad" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2.5 border">
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Address</label>
                                <input type="text" name="address" placeholder="St 1, Sector G-10" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2.5 border">
                            </div>
                        </div>
                    </div>
