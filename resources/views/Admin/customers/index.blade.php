...
@push('scripts')
    <script>
        ...
        function renderHistoryList(tabId, data) {
            ...
            if (data.length === 0) {
                container.innerHTML =
                    `<div class="text-center py-8 text-slate-500 text-sm italic">No records found matching filters.</div>`;
                return;
            }
            ...
            container.innerHTML = data.map(item => {
                ...
                else if (item.status === 'Delivered' || item.status === 'Completed') statusColor =
