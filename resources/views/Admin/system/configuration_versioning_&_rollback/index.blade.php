...
@push('scripts')
    <script>
        ...
        function openDiffModal(version) {
            ...
            // Mocking dynamic impact preview based on version
            if (version === 'v2.3.9') {
        ...
        // One-Click Rollback Action directly from table
        ...
        // Simulate API flow for Rollback
        function simulateRollbackProcess(version, fromModal = false) {
            ...
            setTimeout(() => {
                ...
                location.reload(); // Simulate page refresh to show new table state
            }, 1500);
        }
    </script>
@endpush
