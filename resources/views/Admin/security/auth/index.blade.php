                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="theme-bg-card rounded-xl shadow-sm border theme-border overflow-hidden">
                        <div class="px-6 py-4 border-b theme-border flex justify-between items-center"
                            ...
                            <h3 class="font-semibold theme-text-main flex items-center gap-2">
                                <i data-lucide="log-in" class="w-4 h-4" style="color: rgb(var(--brand-primary));"></i> Login
                                Methods
                            </h3>
                            <span
                                class="px-2 py-1 bg-green-500/10 text-green-500 border border-green-500/20 text-xs font-bold rounded">ACTIVE</span>
                        </div>
                        <div class="p-6 space-y-6">
                            ...
                            <div class="flex items-center justify-between border-t theme-border pt-4">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <div
                                        class="toggle-bg w-11 h-6 bg-gray-600/30 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all">
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="mt-6 p-4 rounded-lg border theme-border theme-bg-body">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-xs font-medium theme-text-muted mb-1">Restricted
                                            Roles</label>
                                        <select id="lr_role"
                                            class="w-full theme-bg-card border theme-border theme-text-main text-sm rounded-lg focus:ring-2 focus:ring-blue-500 block p-2.5">
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium theme-text-muted mb-1">Time Window
                                            Enforcement</label>
                                        <div class="flex gap-2">
                                            <input type="time" id="lr_start" value="00:00"
                                                class="w-full theme-bg-card border theme-border theme-text-main text-sm rounded-lg p-2.5">
                                            <span class="self-center theme-text-muted">-</span>
                                            <input type="time" id="lr_end" value="23:59"
                                                class="w-full theme-bg-card border theme-border theme-text-main text-sm rounded-lg p-2.5">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="theme-bg-card rounded-xl shadow-sm border theme-border overflow-hidden">
                        <div class="px-6 py-4 border-b theme-border" style="background-color: rgba(var(--bg-body), 0.5);">
                            <h3 class="font-semibold theme-text-main flex items-center gap-2">
                                <i data-lucide="lock" class="w-4 h-4" style="color: rgb(var(--brand-primary));"></i>
                                Password Rules
                            </h3>
                        </div>
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                <label class="block text-sm font-medium theme-text-main mb-2">
                                    Minimum Length: <span id="len-val" class="font-bold"
                                        style="color: rgb(var(--brand-primary));">12</span> characters
                                </label>
                            ...
                            <div class="space-y-3">
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" id="pr_uppercase" checked
                                ...
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" id="pr_symbols" checked
                                        class="w-4 h-4 rounded border-gray-300 focus:ring-2 checkbox-brand">
                ...
                <div class="space-y-6">
                    ...
                    <div class="theme-bg-card rounded-xl shadow-sm border theme-border overflow-hidden">
                        <div class="px-6 py-4 border-b theme-border"
                            style="background-color: rgba(var(--brand-primary), 0.1);">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <select id="mfa_policy"
                                    class="w-full theme-bg-body border theme-border theme-text-main text-sm rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500">
                            ...
                            <div>
                                <p class="text-xs font-bold theme-text-muted uppercase tracking-wider mb-3">Allowed Methods
                                </p>
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <input type="checkbox" id="mfa_totp" checked disabled
                                        class="w-4 h-4 rounded bg-gray-500/30 border-gray-500 cursor-not-allowed checked:bg-gray-500">
                                </div>

                                <div class="flex items-center justify-between mb-3">
                                    <span class="text-sm theme-text-main">Email OTP</span>
                                    <input type="checkbox" id="mfa_email" checked
                                        class="w-4 h-4 rounded border-gray-300 focus:ring-2 checkbox-brand">
                                </div>

                                <div class="flex items-center justify-between mb-3">
                                    <span class="text-sm theme-text-main">SMS OTP</span>
                                    <input type="checkbox" id="mfa_sms"
                                        class="w-4 h-4 rounded border-gray-300 focus:ring-2 checkbox-brand">
                                </div>
                            </div>
                        </div>
