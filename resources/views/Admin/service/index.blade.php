...
<div id="service-management-page" 
     class="space-y-6 p-4 md:p-8 bg-gray-50 min-h-screen" 
     x-data="{ openServiceId: null, currentTab: 'pricing' }" 
     x-cloak>
    ...
    <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-gray-200">
        <div class="mb-4 sm:mb-0">
            ...
            <p class="text-xs sm:text-sm text-gray-500 mt-1">Configure service packs, dynamic pricing, regional rules, and skill mappings.</p>
        </div>
        <div class="flex flex-wrap gap-2"> 
            <button class="flex items-center px-3 py-2 text-sm font-medium text-white bg-cyan-600 rounded-lg hover:bg-cyan-700 shadow-md transition duration-150 ease-in-out">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                Add New Service Pack
            </button>
            <button class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-150 ease-in-out shadow-sm">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7"></path></svg>
                Manage Categories
            </button>
        </div>
    </header>
    ...
    <section class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
        @php
            $cards = [
                ['title' => 'Total Service Packs', 'value' => '120', 'icon' => 'list', 'color' => 'cyan', 'trend' => '3 Categories'],
                ['title' => 'Featured Services', 'value' => '15', 'icon' => 'star', 'color' => 'amber', 'trend' => 'High Focus'],
                ['title' => 'Regions with Pricing', 'value' => '12', 'icon' => 'globe', 'color' => 'blue', 'trend' => 'Coverage'],
                ['title' => 'Active Discounts', 'value' => '25', 'icon' => 'tag', 'color' => 'pink', 'trend' => '+5 New'],
                ['title' => 'Services Mapped', 'value' => '98%', 'icon' => 'code', 'color' => 'teal', 'trend' => 'Skills Mapping'],
                ['title' => 'Avg Base Price', 'value' => '$45.00', 'icon' => 'cash', 'color' => 'green', 'trend' => 'Stable'],
                ['title' => 'Highest Demand Cat', 'value' => 'Home Repair', 'icon' => 'home', 'color' => 'indigo', 'trend' => 'Top'],
                ['title' => 'Pending Review', 'value' => '5', 'icon' => 'document', 'color' => 'red', 'trend' => 'Urgent'],
            ];
        @endphp
    ...
    <div class="mt-8 bg-white p-4 sm:p-6 rounded-xl shadow-2xl border border-gray-100">
        ...
        {{-- 3. Service List Table (High-Density, Scrollable, Sticky Actions) --}}
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-cyan-50/50 transition duration-150 ease-in-out group">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center text-xs space-x-2 mt-1">
                                        ...
                                        {{-- Subcategory --}}
                                        <span class="text-gray-500">| Plumbing</span>
                                    </div>
                                    <p class="text-xs text-gray-400 mt-1">Service ID: SVC-1001</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-3 sm:px-6 py-3 text-sm text-gray-500">
                            ...
                            <p class="font-extrabold text-lg text-green-700">$59.99</p>
                            <div class="flex items-center text-xs text-gray-600 mt-1">
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-800">
                                    Dynamic Pricing
                                </span>
                            </div>
                            <p class="text-xs text-gray-400 mt-1">Active in 5 Regions</p>
                        </td>

                        {{-- COL 3: Skills & Discounts --}}
                        <td class="px-3 sm:px-6 py-3 text-sm text-gray-500">
                            <p class="text-xs font-medium text-gray-400 uppercase">Required Skills / Features</p>
                            <p class="font-bold text-gray-700 text-sm">Level 2 Plumbing</p>
                            <div class="flex items-center text-xs text-gray-600 mt-1">
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
                                    Featured Service
                                </span>
                            </div>
                            <p class="text-xs text-pink-600 mt-1">2 Active Discounts</p>
                        </td>

                        {{-- COL 4: Actions (Sticky) --}}
                        <td class="px-3 sm:px-6 py-3 whitespace-nowrap text-right text-sm font-medium sticky right-0 bg-white border-l border-gray-200 group-hover:bg-cyan-50/50">
                            <div class="flex justify-end space-x-2">
                                {{-- View Details (Primary Action) --}}
                                <button @click.stop="openServiceId = 1001; currentTab = 'pricing'" 
                                ...
                                {{-- Toggle Featured --}}
                                <button class="p-2 rounded-full text-amber-500 hover:bg-amber-50 transition duration-150 ease-in-out hidden sm:block" title="Toggle Featured">
                    ...
                    <div class="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                        <div class="p-4 sm:p-6 bg-cyan-600">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <button type="button" class="rounded-md text-cyan-200 hover:text-white" @click="openServiceId = null">
                        ...
                        <nav class="flex space-x-4 px-6 pt-4 border-b border-gray-200 sticky top-0 bg-white z-10 overflow-x-auto">
                            @php
                                $tabs = [
                                    'Pricing Engine', 
                                    'Regionals', 
                        ...
                        <div class="p-6 flex-1 overflow-y-auto space-y-8">
                            ...
                            <div x-show="currentTab === 'pricing-engine'">
                                ...
                                <div class="bg-gray-50 p-4 rounded-xl space-y-3 border">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <input type="number" value="59.99" class="w-24 text-right rounded-lg border-gray-300 text-sm focus:border-cyan-500 focus:ring-cyan-500">
                                    </div>
                                    <div class="flex items-center justify-between border-t pt-3">
                                        <p class="font-medium text-gray-700">Pricing Model</p>
                                        <select class="rounded-lg border-gray-300 text-sm focus:border-cyan-500 focus:ring-cyan-500">
                            ...
                            <div x-show="currentTab === 'regionals'">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4">Region-Based Pricing Overrides</h3>
                                <div class="space-y-3">
                                    ...
                                    <button class="text-sm font-medium text-cyan-600 hover:text-cyan-800 flex items-center mt-3">
                            ...
                            <div x-show="currentTab === 'skills-mapping'">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4">Required Skills and Qualifications</h3>
                                <div class="bg-gray-50 p-4 rounded-xl space-y-3 border">
                                    <label class="font-medium text-gray-700">Minimum Skill Level Required</label>
                                    <select class="w-full rounded-lg border-gray-300 text-sm focus:border-cyan-500 focus:ring-cyan-500">
                                        <option>Plumbing Level 2 (Certified)</option>
                                        <option>Plumbing Level 1 (Trained)</option>
                                    </select>
                                    <div class="pt-2">
                                        <p class="text-sm text-gray-500">Maps service to only eligible vendors/riders.</p>
                                        <button class="text-xs text-cyan-600 hover:underline mt-1">Manage Skill Definitions</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="currentTab === 'discounts'">
                                ...
                                <div class="space-y-3">
                                    <div class="bg-pink-50 p-3 rounded-lg flex justify-between items-center border border-pink-200">
                            ...
                            <div x-show="currentTab === 'featured'">
                                ...
                                <div class="bg-amber-50 p-4 rounded-xl flex justify-between items-center border border-amber-200">
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea rows="3" class="w-full rounded-lg border-gray-300 text-sm focus:border-cyan-500 focus:ring-cyan-500" placeholder="e.g., Fast, reliable sink cleaning in under an hour."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
