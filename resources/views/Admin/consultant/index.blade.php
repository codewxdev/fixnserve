...
@section('content')
    <div class="space-y-6 px-4 sm:px-6 lg:px-8">
        <header class="flex items-center justify-between pt-4">
            ...
            <div>
                ...
                <button type="button"
                    class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-indigo-700 transition duration-150">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8">
                @php
                    $widgets = [
                        ...
                        // Icon: clock -> fa-clock
                        [
                            'title' => 'Hours Consulted This Week',
                            'value' => '245.5',
                            'icon' => 'clock',
                            'color' => 'cyan',
                        ],
        ...
        <section id="sticky-filters" class="sticky top-0 z-10 bg-white pt-4 -mt-4 shadow-sm rounded-lg">
            <form method="GET" action="{{ url()->current() }}"
                ...
                <div class="relative flex-grow">
                    ...
                    <i
                        class="fa-solid fa-search w-4 h-4 absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-400"></i>
                    <input type="text" name="search" placeholder="Search consultant (name, email)..."
                ...
                <select name="expertise"
                    ...
                    <option value="Technology" {{ request('expertise') == 'Technology' ? 'selected' : '' }}>Technology
                    </option>
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-filter w-4 h-4 mr-2"></i> Apply Filters
                </button>
                    ...
                    <div class="min-w-full">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50 sticky z-5">
                                <tr>
                                    <th scope="col"
                                        class="py-3.5 pl-6 pr-3 text-left text-sm font-semibold text-gray-900">Basic Info
                                    </th>
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                                        Consultation Controls</th>
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                                        Performance</th>
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                                        Media/Recordings</th>
                                    <th scope="col" class="relative py-3.5 pl-3 pr-6"><span class="">Actions</span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                @foreach ($consultants as $consultant)
                                    <tr class="hover:bg-indigo-50/50 transition duration-150 cursor-pointer group"
                                        onclick="document.getElementById('consultant-detail-slideover').style.display='block'">
                                        <td class="whitespace-nowrap py-4 pl-6 pr-3 text-sm">
                                            <div class="flex items-center">
                                                <img class="h-10 w-10 rounded-full"
                                                    src="https://ui-avatars.com/api/?name={{ urlencode($consultant['name']) }}&background=random&color=fff"
                                                    alt="">
                                                <div class="ml-4">
                                                    <div class="font-medium text-gray-900">{{ $consultant['name'] }}</div>
                                                    <div class="text-gray-500 text-xs mt-1">Expertise:
                                                        **{{ $consultant['expertise'] }}**</div>
                                                    <div class="flex space-x-1 mt-1">
                                                        <span
                                                            class="inline-flex items-center rounded-full bg-blue-100 px-2 py-0.5 text-xs font-medium text-blue-800">{{ $consultant['expertise'] }}</span>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="space-y-1">
                                                ...
                                                <div class="font-medium text-gray-900 flex items-center"><i
                                                        class="fa-solid fa-calendar-alt w-4 h-4 mr-1 text-indigo-500"></i>
                                                    Next: **2 hours**</div>
                                                <div class="text-gray-500">Rate: **$150/hr**</div>
                                                {{-- Icon: check -> fa-check --}}
                                                <span
                                                    class="inline-flex items-center rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-800"><i
                                                        class="fa-solid fa-check w-3 h-3 mr-1"></i> Available</span>
                                            </div>
                                        </td>

                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="space-y-1">
                                                {{-- Use consultant rating data --}}
                                                <div class="font-medium text-gray-900 flex items-center">
                                                    <i
                                                        class="fa-solid fa-star w-4 h-4 mr-1 text-yellow-400 fill-yellow-400"></i>
                                                    **{{ $consultant['rating'] }}** (120 reviews)
                                                </div>
                                                <div>Total Sessions: **340**</div>
                                                {{-- Icon: slash -> fa-slash --}}
                                                <div class="text-xs text-red-500 flex items-center"><i
                                                        class="fa-solid fa-slash w-3 h-3 mr-1"></i> No-show: **3**</div>
                                            </div>
                                        </td>
    ...
    <div id="consultant-detail-slideover" class="relative z-20" aria-labelledby="slide-over-title" role="dialog"
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                            ...
                            <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-6 z-10">
                                <div class="flex items-start justify-between">
                                    <h2 class="text-2xl font-bold text-gray-900" id="slide-over-title">Jane Doe -
                                ...
                                <div class="mt-2 flex items-center space-x-2">
                                    {{-- Icon: shield-check -> fa-shield-alt --}}
                                    <span
                                        class="inline-flex items-center rounded-full bg-green-100 px-3 py-0.5 text-sm font-medium text-green-800"><i
                                            class="fa-solid fa-shield-alt w-4 h-4 mr-1"></i> **Verified**</span>
                            ...
                            <div class="relative flex-1 px-6 py-6">
                                <div class="space-y-8">
                                    ...
                                    <section>
                                        {{-- Icon: user -> fa-user --}}
                                        <h3
                                            class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center">
                                            <i class="fa-solid fa-user w-5 h-5 mr-2 text-indigo-500"></i> Profile Overview
                                        </h3>
                                        <p class="text-sm text-gray-600 mb-4">"A senior FinTech consultant with 10+ years
                                            in wealth management and blockchain technology."</p>
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <div class="text-sm font-medium text-gray-500">Category</div>
                                                <div class="font-bold text-gray-900">Finance & Markets</div>
                                            </div>
                                            <div>
                                    ...
                                    <section>
                                        ...
                                        <h3
                                            class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center">
                                            <i class="fa-solid fa-calendar-alt w-5 h-5 mr-2 text-indigo-500"></i> Schedule
                                            Management</h3>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-sm font-medium text-gray-700 mb-2">Weekly Availability Calendar
                                            </p>
                                            <div class="text-xs text-gray-500">[Placeholder for a compact, color-coded
                                                availability grid]</div>
                                            <button
                                                class="mt-3 text-sm text-indigo-600 hover:text-indigo-800 font-medium flex items-center">{{-- Icon: plus -> fa-plus --}}<i
                                                    class="fa-solid fa-plus w-4 h-4 mr-1"></i> Add/Edit Slots (Modal
                                                Trigger)</button>
                                        </div>
                                        {{-- Icon: alert-triangle -> fa-exclamation-triangle --}}
                                        <p class="text-xs text-orange-500 mt-2 flex items-center"><i
                                                class="fa-solid fa-exclamation-triangle w-4 h-4 mr-1"></i> **Warning:**
                                            Slot conflict detected on Tuesday, 3 PM.</p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <h3
                                            class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center">
                                            <i class="fa-solid fa-video w-5 h-5 mr-2 text-indigo-500"></i> Session
                                            Recordings</h3>
                                        <div class="space-y-3">
                                            <div
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <span class="text-sm font-medium text-gray-800">2025-12-04 - FinTech
                                                        Strategy (Video)</span>
                                                </div>
                                                <div class="flex items-center space-x-2">
                                                    {{-- Icon: play-circle -> fa-play-circle --}}
                                                    <button class="text-indigo-600 hover:text-indigo-800 text-sm"><i
                                                            class="fa-solid fa-play-circle w-5 h-5"></i></button>
                                                    {{-- Icon: download -> fa-download --}}
                                                    <button class="text-green-600 hover:text-green-800 text-sm"><i
                                                            class="fa-solid fa-download w-5 h-5"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <h3
                                            class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center">
                                            <i class="fa-solid fa-slash w-5 h-5 mr-2 text-orange-500"></i> No-Show & Refund
                                            Rules</h3>
                                        <div class="bg-yellow-50 p-4 rounded-lg mb-4">
                                            <p class="font-medium text-sm text-yellow-800">No-Show Log Timeline (Last 5)
                                            </p>
                                        ...
                                        <div
                                            ...
                                            <div class="space-y-1">
                                                {{-- Icon: rotate-ccw -> fa-undo --}}
                                                <p class="font-medium text-gray-900 flex items-center"><i
                                                        class="fa-solid fa-undo w-4 h-4 mr-2 text-red-600"></i>
                                                    **Auto-Refund Rule**</p>
                                                <p class="text-xs text-gray-500">Trigger 50% refund if session duration <
                                                        10 mins.</p>
                                            </div>
                                            <label for="refund-toggle"
                                    ...
                                    <section>
                                        ...
                                        <h3
                                            class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center">
                                            <i class="fa-solid fa-wallet w-5 h-5 mr-2 text-indigo-500"></i> Earnings &
                                            Wallet</h3>
                                        ...
                                        <p class="text-xs text-gray-500">[Placeholder for Session count vs. Earnings graph]
                                        </p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <h3
                                            class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center">
                                            <i class="fa-solid fa-gavel w-5 h-5 mr-2 text-red-500"></i> Admin Tools</h3>
                                        <div class="space-y-3">
                                            {{-- Icon: ban -> fa-ban --}}
                                            <button
                                                class="w-full justify-center flex items-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 transition"><i
                                                    class="fa-solid fa-ban w-4 h-4 mr-2"></i> Suspend Consultant
                                                Account</button>
                                            {{-- Icon: lock -> fa-lock --}}
                                            <button
                                                class="w-full justify-center flex items-center rounded-md bg-yellow-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-400 transition"><i
                                                    class="fa-solid fa-lock w-4 h-4 mr-2"></i> Require Re-verification
                                                (KYC)</button>
                                        </div>
                                    </section>
                                </div>
