    ...
    <header class="flex items-center justify-between pt-4">
        <div class="flex flex-col">
            <nav class="flex" aria-label="Breadcrumb">
                <ol role="list" class="flex items-center space-x-2 text-sm text-gray-500">
                    <li><a href="#" class="hover:text-gray-700 flex items-center"><i data-lucide="layout-dashboard" class="w-4 h-4 mr-1"></i> Dashboard</a></li>
                    <li class="text-gray-400">/</li>
                    <li><span class="text-indigo-600 font-medium flex items-center"><i data-lucide="user-check" class="w-4 h-4 mr-1"></i> Consultant Management</span></li>
                </ol>
            </nav>
        ...
        <div>
            <button type="button" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-indigo-700 transition duration-150">
                <i data-lucide="user-plus" class="w-4 h-4 mr-2"></i> Add Consultant
            </button>
        </div>
    </header>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8">
            @php
                $widgets = [
                    ...
                    ['title' => 'No-show Cases', 'value' => '14', 'icon' => 'alert-triangle', 'color' => 'orange'],
                    ['title' => 'Pending Refunds', 'value' => '$1,200', 'icon' => 'rotate-ccw', 'color' => 'red'],
                    ['title' => 'Verified Consultants', 'value' => '1,100', 'icon' => 'shield-check', 'color' => 'purple'],
                ];
            @endphp
            ...
            <div class="bg-white p-5 rounded-xl shadow-lg border-t-4 border-{{ $widget['color'] }}-500 transition duration-300 hover:shadow-xl transform hover:-translate-y-0.5">
                <div class="flex items-center justify-between">
                    ...
                    <i data-lucide="{{ $widget['icon'] }}" class="w-5 h-5 text-{{ $widget['color'] }}-500"></i>
                </div>
                <div class="mt-1">
    ...
    <section id="sticky-filters" class="sticky top-0 z-10 bg-white pt-4 -mt-4 shadow-sm rounded-lg">
        <div class="flex space-x-4 p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
            <div class="relative flex-grow">
                <i data-lucide="search" class="w-4 h-4 absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-400"></i>
            ...
            <select class="rounded-lg border border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <button class="flex items-center rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition duration-150">
                <i data-lucide="clock" class="w-4 h-4 mr-1"></i> Availability
            </button>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr class="hover:bg-indigo-50/50 transition duration-150 cursor-pointer group" onclick="document.getElementById('consultant-detail-slideover').style.display='block'">
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <div class="space-y-1">
                                        <div class="font-medium text-gray-900 flex items-center"><i data-lucide="calendar" class="w-4 h-4 mr-1 text-indigo-500"></i> Next: **2 hours**</div>
                                        <div class="text-gray-500">Rate: **$150/hr**</div>
                                        <span class="inline-flex items-center rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-800"><i data-lucide="check" class="w-3 h-3 mr-1"></i> Available</span>
                                    </div>
                                </td>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <div class="space-y-1">
                                        <div class="font-medium text-gray-900 flex items-center">
                                            <i data-lucide="star" class="w-4 h-4 mr-1 text-yellow-400 fill-yellow-400"></i> **4.8** (120 reviews)
                                        </div>
                                        <div>Total Sessions: **340**</div>
                                        <div class="text-xs text-red-500 flex items-center"><i data-lucide="slash" class="w-3 h-3 mr-1"></i> No-show: **3**</div>
                                    </div>
                                </td>

                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <div class="flex items-center space-x-3">
                                        <i data-lucide="video" class="w-5 h-5 text-indigo-500 cursor-pointer hover:text-indigo-700 transition" title="Last Video Session"></i>
                                        <i data-lucide="mic" class="w-5 h-5 text-gray-500 cursor-pointer hover:text-gray-700 transition" title="Last Audio Session"></i>
                                        <i data-lucide="cloud-download" class="w-5 h-5 text-green-500 cursor-pointer hover:text-green-700 transition" title="Download Recent"></i>
                                    </div>
                                </td>
                    ...
                    <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                        ...
                        <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-6 z-10">
                            ...
                            <div class="mt-2 flex items-center space-x-2">
                                <span class="inline-flex items-center rounded-full bg-green-100 px-3 py-0.5 text-sm font-medium text-green-800"><i data-lucide="shield-check" class="w-4 h-4 mr-1"></i> **Verified**</span>
                        ...
                        <div class="relative flex-1 px-6 py-6">
                            <div class="space-y-8">
                                ...
                                <section>
                                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center"><i data-lucide="user" class="w-5 h-5 mr-2 text-indigo-500"></i> Profile Overview</h3>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div><div class="text-sm font-medium text-gray-500">Rating</div><div class="font-bold text-gray-900 flex items-center"><i data-lucide="star" class="w-4 h-4 mr-1 text-yellow-400 fill-yellow-400"></i> 4.8</div></div>
                                    </div>
                                    <div class="mt-4"></div>
                                </section>

                                <section>
                                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center"><i data-lucide="calendar" class="w-5 h-5 mr-2 text-indigo-500"></i> Schedule Management</h3>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <button class="mt-3 text-sm text-indigo-600 hover:text-indigo-800 font-medium flex items-center"><i data-lucide="plus" class="w-4 h-4 mr-1"></i> Add/Edit Slots (Modal Trigger)</button>
                                    </div>
                                    <p class="text-xs text-orange-500 mt-2 flex items-center"><i data-lucide="alert-triangle" class="w-4 h-4 mr-1"></i> **Warning:** Slot conflict detected on Tuesday, 3 PM.</p>
                                </section>
                                
                                <section>
                                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center"><i data-lucide="video" class="w-5 h-5 mr-2 text-indigo-500"></i> Session Recordings</h3>
                                    <div class="space-y-3">
                                        <div class="flex items-center justify-between bg-gray-50 p-3 rounded-lg border">
                                            <div class="flex items-center space-x-3">
                                                <i data-lucide="film" class="w-6 h-6 text-gray-500"></i>
                                                <span class="text-sm font-medium text-gray-800">2025-12-04 - FinTech Strategy (Video)</span>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <button class="text-indigo-600 hover:text-indigo-800 text-sm"><i data-lucide="play-circle" class="w-5 h-5"></i></button>
                                                <button class="text-green-600 hover:text-green-800 text-sm"><i data-lucide="download" class="w-5 h-5"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center"><i data-lucide="slash" class="w-5 h-5 mr-2 text-orange-500"></i> No-Show & Refund Rules</h3>
                                    ...
                                    <div class="flex items-center justify-between p-3 bg-white border rounded-lg shadow-sm">
                                        <div class="space-y-1">
                                            <p class="font-medium text-gray-900 flex items-center"><i data-lucide="rotate-ccw" class="w-4 h-4 mr-2 text-red-600"></i> **Auto-Refund Rule**</p>
                                ...
                                <section>
                                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center"><i data-lucide="wallet" class="w-5 h-5 mr-2 text-indigo-500"></i> Earnings & Wallet</h3>
                                ...
                                <section>
                                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4 flex items-center"><i data-lucide="gavel" class="w-5 h-5 mr-2 text-red-500"></i> Admin Tools</h3>
                                    <div class="space-y-3">
                                        <button class="w-full justify-center flex items-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 transition"><i data-lucide="ban" class="w-4 h-4 mr-2"></i> Suspend Consultant Account</button>
                                        <button class="w-full justify-center flex items-center rounded-md bg-yellow-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-400 transition"><i data-lucide="lock" class="w-4 h-4 mr-2"></i> Require Re-verification (KYC)</button>
                                    </div>
                                </section>
                            </div>
                        </div>
