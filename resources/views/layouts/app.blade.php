                ...
                <div class="flex items-center space-x-4">
                    <div x-data="{ showNotifications: false }" class="relative">
                        ...
                        <div x-show="showNotifications" @click.outside="showNotifications = false"
                            ...
                            <a href="#" class="block p-3 text-center text-xs font-medium text-blue-600 bg-slate-50 hover:bg-blue-50 transition-colors border-t border-gray-100">
                    ...
                    <div x-data="{ open: false }" @click.outside="open = false"
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="p-4 bg-blue-50 border-b border-blue-100 fn-dropdown-header" x-data="{ user: JSON.parse(localStorage.getItem('user')) }">
                                <p class="text-sm font-semibold text-slate-800 fn-dropdown-header-role" x-text="user?.name">
                                    Super Admin</p>
