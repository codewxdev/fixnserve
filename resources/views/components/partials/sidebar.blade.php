        ...
        <ul class="space-y-1 w-full">
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'fraud' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.fraud.scoring') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.fraud.scoring') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Risk Scoring</a></li>
                    <li><a href="{{ route('cp.fraud.accounts') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.fraud.business') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Business Account Risk</a></li>
                    <li><a href="{{ route('cp.fraud.transactions') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.fraud.transactions') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Transaction Fraud</a></li>
                    <li><a href="{{ route('cp.fraud.enforcement') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.fraud.enforcement') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Enforcement</a></li>
                    <li><a href="{{ route('cp.fraud.overrides') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.fraud.overrides') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Manual Overrides</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'disputes' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.disputes.types') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Dispute Types</a></li>
                    <li><a href="{{ route('cp.disputes.workflow') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Dispute Workflow</a></li>
                    <li><a href="{{ route('cp.disputes.evidence') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Evidence Management</a></li>
                    <li><a href="{{ route('cp.disputes.triage') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">AI-Assisted Triage</a></li>
                    <li><a href="{{ route('cp.disputes.escalations') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Legal Escalation</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'audit' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.audit.actions') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.actions') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Admin Action Audit</a></li>
                    <li><a href="{{ route('cp.audit.financial') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.financial') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Financial Audit</a></li>
                    <li><a href="{{ route('cp.audit.security') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.security') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Security Audit</a></li>
                    <li><a href="{{ route('cp.audit.access') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.access') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Data Access Audit</a></li>
                    <li><a href="{{ route('cp.audit.reporting') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.reporting') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Regulatory Reporting</a></li>
                    <li><a href="{{ route('cp.audit.retention') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.retention') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Data Retention</a></li>
                    <li><a href="{{ route('cp.audit.forensics') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors {{ request()->routeIs('cp.audit.forensics') ? 'font-semibold text-brand-primary bg-brand-primary/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary' }}">Forensic Replay</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'analytics' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.analytics.executive') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Executive Reports</a></li>
                    <li><a href="{{ route('cp.analytics.financial') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Financial Reports</a></li>
                    <li><a href="{{ route('cp.analytics.operational') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Operational Reports</a></li>
                    <li><a href="{{ route('cp.analytics.builder') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Custom Report Builder</a></li>
                    <li><a href="{{ route('cp.analytics.scheduled') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Scheduled Reports</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'support' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.support.tickets') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Ticket System</a></li>
                    <li><a href="{{ route('cp.support.sla') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">SLA Management</a></li>
                    <li><a href="{{ route('cp.support.workspace') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Agent Workspace</a></li>
                    <li><a href="{{ route('cp.support.incidents') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Incident Management</a></li>
                    <li><a href="{{ route('cp.support.knowledge') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Knowledge Base</a></li>
                    <li><a href="{{ route('cp.support.assistant') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">AI Support Assistant</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'ai' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.ai.orchestrator') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Decision Orchestrator</a></li>
                    <li><a href="{{ route('cp.ai.intelligence') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Business Intelligence</a></li>
                    <li><a href="{{ route('cp.ai.fraud') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Fraud AI</a></li>
                    <li><a href="{{ route('cp.ai.operations') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Operations AI</a></li>
                    <li><a href="{{ route('cp.ai.engine') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Automation Rule Engine</a></li>
                    <li><a href="{{ route('cp.ai.hitl') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Human-In-The-Loop</a></li>
                    <li><a href="{{ route('cp.ai.governance') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Model Governance</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul x-show="activeDropdown === 'integrations' && sidebarOpen" x-collapse
                    class="mt-1 space-y-0.5 px-2 whitespace-nowrap" x-cloak>
                    <li><a href="{{ route('cp.integrations.registry') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Integration Registry</a></li>
                    <li><a href="{{ route('cp.integrations.credentials') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Credential Management</a></li>
                    <li><a href="{{ route('cp.integrations.health') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Health Monitoring</a></li>
                    <li><a href="{{ route('cp.integrations.webhooks') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Webhook Governance</a></li>
                    <li><a href="{{ route('cp.integrations.vendors') }}" class="block py-1.5 pl-9 pr-3 rounded-md text-caption transition-colors text-text-secondary hover:text-text-primary hover:bg-bg-tertiary">Vendor Performance</a></li>
                </ul>
            </li>
