...
Route::middleware('health_api', 'check_country', 'country.detect', 'locale.set', 'currency.set', 'language.initialize', 'risk.track',
    'risk.velocity', 'session.risk')->group(function () {
        ...
        Route::middleware(['auth:api', 'user.active', 'active.session', 'device.bind', 'token.role', 'network.security', 'risk.track',
